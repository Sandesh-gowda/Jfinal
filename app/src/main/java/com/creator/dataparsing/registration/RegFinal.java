 ...
 */
public class RegFinal extends AppCompatActivity implements View.OnClickListener {
        ...
        VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.POST, url, new Response.Listener<NetworkResponse>() {
            ...
            public void onResponse(NetworkResponse response) {
                ...
                try {
                    ...
                    Intent inten = new Intent(getApplicationContext(),HolderFragmentHome.class);
                    startActivity(inten);
                    finish();
