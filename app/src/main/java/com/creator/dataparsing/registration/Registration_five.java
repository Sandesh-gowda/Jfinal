...
//profile
public class Registration_five extends AppCompatActivity implements View.OnClickListener{

    public static final int REQUEST_CAMERA = 0, SELECT_FILE = 1, PICK_INSURANCE_REQUEST_CODE = 2, PICK_RCBOOK_REQUEST_CODE = 3;
    String upResume;
    LinearLayout procced, uploadResume, uploadresumeGoogle;
    ...
    private void initViews()
    {
        ...
        procced = (LinearLayout)findViewById(R.id.upload_resume_btn);
        uploadResume  =(LinearLayout)findViewById(R.id.upload_resume);
        uploadresumeGoogle = (LinearLayout)findViewById(R.id.mobile_invisible) ;
        uploadresumeGoogle.setOnClickListener(this);
    ...
    private void callData(final String id, final String getprofilePic) {
        ...
        String url = "http://www.jaldijob.in/test/test/v1/resume";
        VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.POST, url, new Response.Listener<NetworkResponse>() {
            ...
            public void onResponse(NetworkResponse response) {
                ...
                try {
                    ...
                    Intent inten = new Intent(getApplicationContext(),RegFinal.class);
                    startActivity(inten);
                    finish();
            ...
            protected Map<String, DataPart> getByteData() {
                ...
                try {
                    ...
                    if (!getprofilePic.equals("")) {
                        ...
                        params.put("resume", new DataPart(new File(getprofilePic).getName(), AppHelper.bitmapToByteArray(bmpPic), "image/jpeg"));
                    } else {
                        bmpPic = BitmapFactory.decodeResource(getResources(), R.drawable.a);
                        params.put("resume", new DataPart("a.jpg", AppHelper.bitmapToByteArray(bmpPic), "image/jpeg"));
